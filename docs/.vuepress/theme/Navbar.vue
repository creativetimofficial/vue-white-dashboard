    ...
    <base-nav class="main-nav flex-row align-items-md-center" type="" effect="light" expand>
      ...
      <div class="navbar-nav-scroll ml-md-auto ">
        <ul class="navbar-nav bd-navbar-nav flex-row">
          <li class="nav-item">
            <a target="_blank" href="https://www.creative-tim.com/product/vue-white-dashboard-pro?ref=vwd-upgrade-pro" class="btn btn-round"><i class="tim-icons icon-send mr-2"></i>Upgrade to PRO</a>
          </li>
          <li class="nav-item">
